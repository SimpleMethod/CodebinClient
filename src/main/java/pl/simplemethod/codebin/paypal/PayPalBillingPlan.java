...
public class PayPalBillingPlan {
    ...
    private static final String CANCEL_URL = "https://simplemethod.io/dashboard.html#!/payment-error";
    private static final String PROCESS_URL = "https://simplemethod.io/paypal/payment-success";
